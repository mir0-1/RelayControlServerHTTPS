...
bool Server::subhandleRequestAsHardwareRead(const HttpRequest& request)
{
    ...
    std::cout << "DEBUG " << (int)relayController.getLastKnownRelayStateByIndex(0);
    std::cout << "DEBUG " << (int)relayController.getLastKnownRelayStateByIndex(1);
    std::cout << "DEBUG " << (int)relayController.getLastKnownRelayStateByIndex(2);
    std::cout << "DEBUG " << (int)relayController.getLastKnownRelayStateByIndex(3);
